...
PromptCraft是一款轻量化、高效的AI提示词生成工具，专注于为用户快速生成多种风格的高质量提示词。本项目采用极简架构设计，确保在6小时内完成从开发到部署的全流程。
...
docker run -p 8080:8080 promptcraft
```
